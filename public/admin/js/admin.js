...
(function ($) {
    ...
    $.fn.appTable = function (options) {
        ...
        if (typeof settings.checkBoxes[0] !== 'undefined') {
            ...
            settings.filterParams[name] = values;
            var checkboxDom = '<div class="mr15 DTTT_container">' + '<div class="btn-group filter" data-act="checkbox" data-toggle="buttons">' + checkboxes + '</div>' + '</div>';
        ...
        if (typeof settings.radioButtons[0] !== 'undefined') {
            ...
            var radioDom = '<div class="mr15 DTTT_container">' + '<div class="btn-group filter" data-act="radio" data-toggle="buttons">' + radiobuttons + '</div>' + '</div>';
        ...
        if (typeof settings.singleDatepicker[0] !== 'undefined') {
            ...
            $.each(settings.singleDatepicker, function (index, datePicker) {
                ...
                var selectDom = '<div class="mr15 DTTT_container">' + '<button name="' + datePicker.name + '" class="btn datepicker-custom-selector">' + getDatePickerText(selectedText) + '</button>' + '</div>';
        ...
        if (typeof settings.rangeDatepicker[0] !== 'undefined') {
            ...
            $.each(settings.rangeDatepicker, function (index, datePicker) {
                ...
                //prepare DOM
                var selectDom = '<div class="mr15 DTTT_container">' + '<div class="input-daterange input-group">' + '<button class="btn btn-default form-control" name="' + startDate.name + '" data-date="' + startDate.value + '">' + startButtonText + '</button>' + '<span class="input-group-addon">-</span>' + '<button class="btn btn-default form-control" name="' + endDate.name + '" data-date="' + endDate.value + '">' + endButtonText + '' + '</div>' + '</div>';
        ...
        if (typeof settings.filterDropdown[0] !== 'undefined') {
            ...
            $.each(settings.filterDropdown, function (index, dropdown) {
                ...
                var selectDom = '<div class="mr15 DTTT_container">' + '<select class="' + dropdown.class + '" name="' + dropdown.name + '">' + optons + '</select>' + '</div>';
                $instanceWrapper.find(".custom-toolbar").append(selectDom);
